...
class UserRegistrationForm(UserCreationForm):
    ...
    def save(self,commit=True):
        ...
        """
        ekhon e database a data save korbona. our_user hoilo User model er ekta instance. jeita amra ekhon e save korbona. karon eita niye amra additional kichu kaj korte chai.
        """
        if commit == True:
            our_user.save() # ultimately amra User Model a data save korlam
            ...
            UserBankAccount.objects.create(
                ...
                account_no = 100000+our_user.id # otirikto kaj korlam
            )
        return our_user
